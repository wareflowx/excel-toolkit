...
def dataframe_with_bad_columns():
    ...
    return pd.DataFrame(
        {"First Name": ["John", "Jane"], "Last Name!": ["Doe", "Smith"], "AGE": [25, 30]}
    )
...
class TestTrimWhitespace:
    ...
    def test_trim_preserves_nan(self):
        ...
        df = pd.DataFrame({"Name": ["  John  ", None, " Jane "], "Age": [25, 30, 35]})
...
class TestFillMissingValues:
    ...
    def test_forward_fill_single_column(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="forward", columns=["Age"]
        )
    ...
    def test_backward_fill_single_column(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="backward", columns=["Age"]
        )
    ...
    def test_mean_fill_numeric_column(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="mean", columns=["Age"]
        )
    ...
    def test_median_fill_numeric_column(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="median", columns=["Salary"]
        )
    ...
    def test_constant_fill(self, dataframe_with_missing_values):
        """Test constant fill."""
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="constant", columns=["Name"], value="Unknown"
        )
    ...
    def test_drop_rows_with_missing(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="drop", columns=["Name"]
        )
    ...
    def test_column_not_found(self, dataframe_with_missing_values):
        """Test error when column doesn't exist."""
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="mean", columns=["InvalidColumn"]
        )
    ...
    def test_invalid_strategy(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="invalid", columns=["Age"]
        )
    ...
    def test_mean_on_non_numeric_column(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="mean", columns=["Name"]
        )
    ...
    def test_constant_without_value(self, dataframe_with_missing_values):
        ...
        result = fill_missing_values(
            dataframe_with_missing_values, strategy="constant", columns=["Name"]
        )
...
class TestStandardizeColumns:
    ...
    def test_ensure_uniqueness(self):
        ...
        df = pd.DataFrame({"Name": ["John", "Jane"], "name": ["Doe", "Smith"], "NAME": ["A", "B"]})
...
class TestCleanDataframe:
    ...
    def test_apply_subset_of_operations(self, messy_dataframe):
        ...
        result = clean_dataframe(messy_dataframe, trim=True, remove_dup=True)
    ...
    def test_operations_in_correct_order(self):
        ...
        df = pd.DataFrame({"  First Name  ": ["  John  ", " Jane "], "Age": [25, 30]})
        result = clean_dataframe(df, standardize=True, standardize_case="lower", trim=True)
    ...
    def test_error_propagates(self, messy_dataframe):
        ...
        result = clean_dataframe(messy_dataframe, trim=True, trim_columns=["InvalidColumn"])
...
class TestCleaningIntegration:
    ...
    def test_cleaning_preserves_data_types(self):
        ...
        df = pd.DataFrame(
            {"ID": [1, 2, 3], "Name": ["Alice", "Bob", "Charlie"], "Age": [25.5, 30.0, 35.5]}
        )
